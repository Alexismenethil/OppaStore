# homepage-trends-headline

## Purpose

Definir el titular de tendencias mostrado en la página principal para que comunique el alcance de OppaStore sin depender de una ciudad fija.
