 ...
 * RF22–RF26: lista, cantidades con límite de stock, eliminar, totales en vivo.
 */
        ...
        <>
          ...
          >
            <div className="mb-md flex items-center justify-between">
              <div>
                <h2 className="font-heading text-headline-sm text-primary">Tu Carrito</h2>
              ...
              <>
                ...
                <div className="mt-md border-t border-outline-variant pt-md">
                  ...
                  <p className="mt-sm text-center text-[12px] italic text-on-surface-variant">
                    Tu pedido se enviará como un mensaje pre-llenado 💬
                  </p>
                </div>
              </>
            )}
